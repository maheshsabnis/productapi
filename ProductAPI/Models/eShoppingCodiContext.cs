...
//                optionsBuilder.UseSqlServer("Data Source=127.0.0.1;Initial Catalog=eShoppingCodi;User Id=sa;Password=MyPass@word");
//            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                entity.HasKey(e => e.ProductUniqueId)
                    .HasName("PK__Product__8377B53AEE4B7A2C");
            ...
            modelBuilder.Entity<ProductInfo>(entity =>
            {
                entity.HasKey(e => e.ProductRowId)
                    .HasName("PK__ProductI__2F7036E151FEC90E");

                entity.ToTable("ProductInfo");

                entity.HasIndex(e => e.ProductId, "UQ__ProductI__B40CC6CCC45D1659")
                    .IsUnique();
